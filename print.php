...
if(isset($_POST['data']))
{
    $_SESSION['print']=json_decode($_POST['data']);
}
?>
<!doctype html>
<html lang="en">
...
function printDiv(data,id) {
  ...
  <div class="px-5">
    ...
    <div class="container justify-content-center border border-3 mt-2">
    <div class="row mb-3">
      <div class="col">
        Adm No.: ${id[0]}
      </div>
...
Particulars
      ...
      <div class=" h4 col-4 border-start border-3 p-3 mb-0">
Amount
      </div>
    </div>
  ...
  <p>Fee</p>
      ...
      <div class="col-4 border-start border-3 p-3" style="height: 30vh;">
    ${data[3]}
      </div>
      </div>
      <div class="row border border-3 border-top-0" >
  ...
  <h4>Total</h4>
      ...
      <div class="col-4 border-start border-3 p-3">
      ${data[3]}
      </div>
      </div>
    </div>
